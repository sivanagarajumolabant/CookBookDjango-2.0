# Generated by Django 3.2.11 on 2022-10-12 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Parent_Object_Type', models.CharField(blank=True, max_length=100)),
                ('Child_Object_Type', models.CharField(max_length=100, null=True)),
                ('rules_toApply', models.CharField(blank=True, max_length=1000)),
            ],
        ),
        migrations.CreateModel(
            name='Migrations',
